              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-base text-black leading-tight">
                    ...
                    גם כאשר מגיעים להסכם מאוזן, שינוי נסיבות בלתי צפוי עלול לערער אותו.
                    <span className="font-brand">NEST</span> מעניקה ללקוחותיכם רשת ביטחון כלכלית שמבטיחה את המשך תשלומי המזונות
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside text-base text-black leading-tight space-y-0.5">
                    ...
                    <li>
                      <span className="font-brand">NEST</span> מזמינה את עורכי הדין להציע מנגנון שמונע מחלוקות עתידיות, מחזק את ההסכם
                      ומשפר את איכות הייצוג, כאשר ההגנה על טובת הילדים משרתת את שני הצדדים.
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-base text-black leading-tight">
                    ...
                    זהו מנגנון הוגן ושקוף שמגן על שני ההורים במידה שווה, מחזק את ההסכם ומבטיח שאף אחד לא נותר לבד עם הנטל הכלכלי.
                    במקרים של הורות או משמורת משותפת, שבהם שני ההורים חולקים את ההוצאות באופן מאוזן, NEST הופכת משמעותית במיוחד.
                    הפוליסה שומרת על האיזון, מונעת קריסה כלכלית של אחד הצדדים במקרה של אירוע פתאומי,
                    ומבטיחה שהילדים ימשיכו לקבל את התמיכה שנקבעה עבורם.
                    NEST מאפשרת לשני ההורים לעמוד יחד מאחורי המחויבות לילדים, גם אחרי הפרידה.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside text-base text-black leading-tight space-y-0.5">
                    ...
                    <li>חיסכון בזמן ובהתמודדות עם תיקי המשך ומחלוקות עתידיות.</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="text-base text-black leading-tight">
                    ...
                    שותפי NEST הם אלו שמובילים את התחום, מאמצים פתרון שמעניק יציבות למשפחות ומגדיל את הערך שהם מציעים ללקוחות.
                  </p>
                </div>
                <Link
                  href="/contact"
