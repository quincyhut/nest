              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-base text-black leading-tight">
                    ...
                    יציבות, ומנגנוני אכיפה ברורים לאורך זמן. חלוקת הוצאות גידול
                    הילדים היא אחד המרכיבים המרכזיים למחלוקות בין הורים נפרדים.
                    גם כאשר מגיעים להסכם מאוזן, שינוי נסיבות בלתי צפוי עלול
                    לערער אותו.
                    <span className="!font-bold">
                      <span className="font-brand !font-bold">NEST</span> מעניקה ללקוחותיכם
                      רשת ביטחון כלכלית שמבטיחה את המשך תשלומי המזונות במקרה שבו
                      ההורה המשלם אינו מסוגל לעמוד בהתחייבותו.
                    </span>
                  </p>
                </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-base text-black leading-tight">
                    ...
                    מיותר. זהו מנגנון הוגן ושקוף שמגן על שני ההורים במידה שווה,
                    מחזק את ההסכם ומבטיח שאף אחד לא נותר לבד עם הנטל הכלכלי.
                    במקרים של הורות או משמורת משותפת, שבהם שני ההורים חולקים את
                    ההוצאות באופן מאוזן, NEST הופכת משמעותית במיוחד. הפוליסה
                    שומרת על האיזון, מונעת קריסה כלכלית של אחד הצדדים במקרה של
                    אירוע פתאומי, ומבטיחה שהילדים ימשיכו לקבל את התמיכה שנקבעה
                    עבורם.{" "}
                    <span className="!font-bold">
                      <span className="font-brand !font-bold">NEST</span> מאפשרת לשני ההורים לעמוד יחד מאחורי המחויבות
                      לילדים, גם אחרי הפרידה.
                    </span>
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-base text-black leading-tight">
                    ...
                    ליווי אישי, וחומרי הסברה איכותיים. שותפי NEST הם אלו
                    שמובילים את התחום, מאמצים פתרון שמעניק יציבות למשפחות ומגדיל
                    את הערך שהם מציעים ללקוחות.
                  </p>
                </div>
                <Link
                  href="/contact"
