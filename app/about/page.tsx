        ...
        <div className="flex flex-col-reverse md:flex-row gap-6 md:gap-8 max-w-[75rem] justify-end w-full">
          ...
          >
            ...
            <p className="mt-4 text-base text-black ">
              <span className="font-brand">NEST</span> הוקמה מתוך הבנה שהשינוי המשפחתי אינו אמור לפגוע בילדים.
              ...
              נושא לבדו בנטל הכלכלי. <span className="font-brand">NEST</span> מעניקה שכבת הגנה שמבטיחה שהמזונות
              ...
              ומחויבים לשקיפות, מקצועיות ורגישות אנושית. <span className="font-brand">NEST</span> פועלת בשיתוף פעולה
